...
(function ($) {
     ...
     **/
    var launch = new Date(2020, 08, 16, 20, 55);
    /**
     * The script
     **/
    var message = $('#message');
    ...
    function setDate() {
        ...
        count = count + pecaspemm;

        if (launch < now) {
            days.html('<h1>0</H1><p>Day</p>');
            hours.html('<h1>0</h1><p>Hour</p>');
            minutes.html('<h1>0</h1><p>Minute</p>');
            seconds.html('<h1>0</h1><p>Peças</p>');
            ...
            s = Math.floor(s - m * 60);
            seconds.html('<h1>' + Math.round(count) + '</h1><p>Peças' + (s > 1 ? 's' : ''), '</p>');
